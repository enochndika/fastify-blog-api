...
var prisma_1 = __importDefault(require("@providers/prisma"));
var jwt_strategy_1 = __importDefault(require("./jwt.strategy"));
var validatePassword_1 = __importDefault(require("./validatePassword"));
function signIn(request, reply) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, password, username, user, isValidated;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, validatePassword_1.default)(password, user)];
                case 2:
                    isValidated = _b.sent();
                    if (!isValidated) {
                        reply.statusCode = 400;
                        return [2 /*return*/, { message: "Mot de passe incorrect" }];
                    }
                ...
                case 3:
                    _b.sent();
                    return [2 /*return*/, (0, jwt_strategy_1.default)(user)];
            }
        });
    });
}
